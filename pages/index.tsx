...
import { HireUs } from "../components/layout/Aniruddh";
...
export default function Home() {
  ...
  const [settings, setSettings] = React.useState<ISettings>({
    apikey: "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",
    sampleRows: 10,
    model: "gpt-3.5-turbo"
  });
  ...
  return (
    <>
      <Head>
        <title>Nexus Visualize</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
 
        <meta property="og:title" content="Nexus Visualize" />
        <meta
          property="og:description"
          content="Visualize data with our tool created using technology"
        />
